...
prehelp = """
NAME
    mg-compare-heatmap-functions

VERSION
    %s

SYNOPSIS
    mg-compare-heatmap-functions [ --help, --user <user>, --passwd <password>, --token <oAuth token>, --ids <metagenome ids>, --level <functional level>, --source <datasource>, --evalue <evalue negative exponent>, --identity <percent identity>, --length <alignment length>, --cluster <cv: ward, single, complete, mcquitty, median, centroid>, --distance <cv: bray-curtis, euclidean, maximum, manhattan, canberra, minkowski, difference> ]

DESCRIPTION
    Retrieve Dendogram Heatmap from functional abundance profiles for multiple metagenomes.
"""
...
EXAMPLES
    mg-compare-heatmap-functions --ids "kb|mg.286,kb|mg.287,kb|mg.288,kb|mg.289" --level level2 --source KO --cluster median --distance euclidean --evalue 8

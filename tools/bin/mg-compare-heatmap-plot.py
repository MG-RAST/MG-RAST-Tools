...
SYNOPSIS
    mg-compare-heatmap-plot [ --help, --input <input file or stdin>, --format <cv: 'text' or 'biom'>, --plot <filename for png>, --cluster <cv: ward, single, complete, mcquitty, median, centroid>, --distance <cv: bray-curtis, euclidean, maximum, manhattan, canberra, minkowski, difference>, --rlib <R lib path>, --height <image height in inches> --width <image width in inches> --dpi <image DPI> --order <boolean>, --label <boolean> ]

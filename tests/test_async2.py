...
def test_async():
    ...
    URI = 'http://api.metagenomics.anl.gov/1/matrix/organism?hit_type=single&group_level=strain&evalue=15&auth=6rNNfdmuJfgLr5ZCnrFmcz6ts&source=RefSeq&result_type=abundance&id=mgm4653783.3&asynchronous=1'
